"""
Ecoli dataset loader — CT 2.3: SMOTETomek + Imbalance Ratio thay đổi.

Giống Ecoli_TestSize_IR.py nhưng áp dụng SMOTETomek trên tập train
...
def load_data(test_size, new_rate):
    ...
    ecoli_map = {' im': 1.0, ' cp': -1.0, 'imL': -1.0, 'imS': -1.0,
                 'imU': -1.0, ' om': -1.0, 'omL': -1.0, ' pp': -1.0}
