"""
Co-Author dataset loader — CT 2.3: SMOTETomek + Imbalance Ratio thay đổi.

Giống Co_Author_TestSize_IR.py nhưng áp dụng SMOTETomek trên tập train
...
def load_data(test_size, new_rate):
    data = pd.read_csv('D:/research/Thu-Nghiem/data/datasets/CoAuthor_500_2500.csv')
    X = data.values[:, 0:-1]
    y = data.values[:, 7]
