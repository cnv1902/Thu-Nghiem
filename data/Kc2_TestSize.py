<<<<<<< HEAD
"""KC2 (Software Faults) dataset loader - TestSize split."""
...
def load_data(test_size):
    dataset_path = Path(__file__).resolve().parent / "datasets" / "Software-Faults" / "kc2.csv"
...
def load_data(test_size):
    df = read_promise_arff_dataframe(
        'D:/research/Thu-Nghiem/data/datasets/Software-Faults/kc2.csv'
    )
